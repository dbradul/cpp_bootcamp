...
//            };
...

            {
                ...
                ifstream file;
                file.open("C:\\Users\\student\\Work\\cpp_bootcamp\\QuickSort.txt");
...
//                cout << v << endl;
                ...
                transform(start,
                          ...
                          back_inserter(v2),
                          [](const int &elem){return Box1{elem, static_cast<char>(97+rand()%26)};});
                ...
                bool b2 = equal(v_stable_sort.begin(), v_stable_sort.end(),
                      v2.begin(),
                      [](const Box1 &a, const Box1 &b)

                      { bool b42 = a.value==b.value && a.ch_value==b.ch_value;
//                        if (!b42)
//                        {
//                            cout << "a: " << a << endl;
//                            cout << "b: " << b << endl;
//                        }
                ...
                cout << "stable vs unstable: " << b2 << endl;
            }
